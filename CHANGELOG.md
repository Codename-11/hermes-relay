...
- **Hermes appears in OEM Android assistant pickers.** The app now advertises the standard Assist activity entry point alongside its voice-interaction service and routes either invocation through the same assistant session lifecycle.
