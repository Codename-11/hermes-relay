...
<p align="center">
  <img src="assets/readme-connection-map-v2.png" alt="How Hermes-Relay connects — Dashboard and Gateway connect directly to Android for the standard path; the Relay plugin is installed on Hermes and separately adds Android enhancements plus CLI and UI tools; sideload adds Device Control." width="1000">
</p>
