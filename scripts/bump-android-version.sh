...
echo "       and app/src/googlePlay/play/release-notes/en-US/default.txt"
echo "       (Play Console 'What's new' — gradle-play-publisher reads this; <=500 chars/lang)"
echo "    2. Commit on dev:"
echo "         git add $LIBS CHANGELOG.md RELEASE_NOTES.md app/src/main/assets/whats_new.txt app/src/googlePlay/play/release-notes/en-US/default.txt"
