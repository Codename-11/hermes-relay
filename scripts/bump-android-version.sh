...
echo "       requires one overall title + summary, a complete changes[] inventory"
echo "       with unique ids/kinds/titles/explanations and 1..4 highlights, optional"
echo "       compatibility bullets, and playNotes. Toast counts/previews are derived."
