...
| `ui/screens/BridgeScreen.kt`                                | Bridge cockpit — master → visible Agent access posture/setup → capability-scoped Android readiness (expandable full matrix) → Advanced/unattended → Safety/full editor → activity log                                                                                                              |
| `ui/components/BridgeAccessCards.kt`                        | Native access cockpit + first-use preset and timed-screen sheets; preserves full permission/safety drilldowns while keeping selected policy/readiness above the fold                                                                                                                               |
