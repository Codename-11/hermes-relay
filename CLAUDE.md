...
| `ui/screens/BridgeScreen.kt`                                | Bridge UI — master → permission checklist → Advanced/unattended → Safety & capabilities → activity log; unattended is effective only with timed screen-control authority                                                                                                                            |
