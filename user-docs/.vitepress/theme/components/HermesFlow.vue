...
const diagrams: Record<string, DiagramDef> = {
  ...
  'architecture': {
    nodes: [
      ...
      { id: 'relay', type: 'hermes', position: { x: 480, y: 100 }, data: { label: 'Relay :8767' }, sourcePosition: Position.Right, targetPosition: Position.Left },
      { id: 'bridge-relay', type: 'hermes', position: { x: 480, y: 180 }, data: { label: 'Bridge :8766' }, sourcePosition: Position.Right, targetPosition: Position.Left },
    ...
    edges: [
      ...
      { id: 'e5', source: 'conn-mgr', target: 'bridge-relay', animated: edgeAnimated, style: edgeDim },
      { id: 'e6', source: 'api-server', target: 'chat', style: edgeStyle },
      { id: 'e7', source: 'relay', target: 'terminal', style: edgeDim },
      { id: 'e8', source: 'bridge-relay', target: 'bridge', style: edgeDim },
    ],
  },
